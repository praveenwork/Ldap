...
public class LdapClient {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://<<HOST>>:389";
        final String ldapSearchBase = "<<SEARCHBASE>>";
        ...
        ldap.findAllAccount(ctx, ldapSearchBase);
    ...
    public void findAllAccount(DirContext ctx, String ldapSearchBase) throws NamingException {
